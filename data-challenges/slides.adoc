...
[role="speaker"]
====
* Even if disaster-level failures are handled, there will be a time when software needs to be updated
...
class WordCounterMapper implements Reducer<String, Integer> { <1>
