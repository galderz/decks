...
JUDCon India 2014 ; Bangalore ; 2014/01/30
...
[role="speaker"]
====
* Here's a Scala version of the previous Hello World verticle, less verbose, function passing better
* A similar thing will be doable w/ Java 8, but Scala's goes well beyond just passing functions
...
* Not ready, but as soon as we have 1-to-1 mapping with Java API, we'll start working on it :)
* Let's run this demo -> Go to `Terminal`
====
